...
import nyoto from "@/assets/proj-nyoto.png";
import tohc from "@/assets/proj-tohc.png";
import amantra from "@/assets/proj-amantra.png";
import travco from "@/assets/proj-travco.png";
import turant from "@/assets/proj-turant.png";
import mumal from "@/assets/proj-mumal.png";
import insta from "@/assets/proj-insta.png";
...
export const Work = () => {
  return (
    <section id="work" className="editorial py-24 md:py-32 space-y-32">
      ...
      <motion.article {...reveal} className="relative grid grid-cols-12 gap-8 items-center bg-foreground text-background py-20 -mx-6 md:-mx-10 lg:-mx-14 px-6 md:px-10 lg:px-14">
        ...
        <div className="col-span-12 md:col-span-6 order-first md:order-none">
          <div className="aspect-[4/3] overflow-hidden grain">
            <img src={nyoto} alt="Nyoto restaurant brand identity" className="w-full h-full object-contain" loading="lazy" />
          </div>
        </div>
      ...
      {/* 02 — T.O.H.C. — healthcare, quote left, image right */}
      <motion.article {...reveal} className="grid grid-cols-12 gap-8">
        <div className="col-span-12 md:col-span-5 md:pt-20">
          <p className="font-mono-label text-foreground/60 mb-4">02 / Healthcare · Brand · 2024</p>
        ...
        <div className="col-span-12 md:col-span-7">
          <div className="aspect-[4/3] overflow-hidden grain">
            <img src={tohc} alt="The Oxygen Health Care brand and campaign" className="w-full h-full object-contain hover:scale-105 transition-transform duration-700" loading="lazy" />
          </div>
        </div>
      </motion.article>

      {/* 03 — Amantra — massive number + image */}
      <motion.article {...reveal} className="grid grid-cols-12 gap-4 items-center">
        ...
        <div className="col-span-12 md:col-span-5">
          <div className="aspect-[4/5] overflow-hidden grain">
            <img src={amantra} alt="Amantra Shilpi resort campaign" className="w-full h-full object-contain" loading="lazy" />
          </div>
      ...
      {/* 04 — Travco — editorial spread */}
      <motion.article {...reveal} className="grid grid-cols-12 gap-8 items-start">
        <div className="col-span-12 md:col-span-7">
          <div className="aspect-[5/4] overflow-hidden grain">
            <img src={travco} alt="Travco travel brand campaign" className="w-full h-full object-contain hover:scale-105 transition-transform duration-700" loading="lazy" />
          </div>
        </div>
        <div className="col-span-12 md:col-span-5 space-y-6">
          <p className="font-mono-label text-foreground/60">04 / Travel · Brand · Social · 2025</p>
      ...
      {/* 05 — Turant — tall product, side meta */}
      <motion.article {...reveal} className="grid grid-cols-12 gap-8 items-center">
        <div className="col-span-12 md:col-span-4 space-y-4 md:order-2">
          <p className="font-mono-label text-foreground/60">05 / Mobile App · 2025</p>
        ...
        <div className="col-span-12 md:col-span-8 md:order-1">
          <div className="aspect-[16/10] overflow-hidden grain bg-secondary">
            <img src={turant} alt="Turant delivery app brand and product" className="w-full h-full object-contain hover:scale-105 transition-transform duration-700" loading="lazy" />
          </div>
        </div>
      </motion.article>

      {/* 06 — Mumal — packaging full bleed */}
      <motion.article {...reveal} className="grid grid-cols-12 gap-8 items-end">
        <div className="col-span-12 md:col-span-5 md:pb-12 space-y-4">
          <p className="font-mono-label text-foreground/60">06 / Packaging · FMCG · 2024</p>
        ...
        <div className="col-span-12 md:col-span-7">
          <div className="aspect-[4/3] overflow-hidden grain">
            <img src={mumal} alt="Mumal popcorn packaging range" className="w-full h-full object-contain hover:scale-105 transition-transform duration-700" loading="lazy" />
          </div>
        </div>
      </motion.article>

      {/* 07 — Insta Story — centered hero */}
      <motion.article {...reveal} className="grid grid-cols-12 gap-8">
        <div className="col-span-12 text-center space-y-4 mb-4">
          <p className="font-mono-label text-foreground/60">07 / Social Design · Ongoing</p>
        ...
        <div className="col-span-12 md:col-span-10 md:col-start-2">
          <div className="aspect-[16/9] overflow-hidden grain">
            <img src={insta} alt="Insta Story festival design system" className="w-full h-full object-contain hover:scale-105 transition-transform duration-700" loading="lazy" />
          </div>
        </div>
      </motion.article>
    </section>
